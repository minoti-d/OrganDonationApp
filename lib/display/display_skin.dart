...
class display_skin extends StatelessWidget {
  final ref = FirebaseFirestore.instance.collection('skin_donors');
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("Skin Problems : " + snapshot.data!.docs[index].data()['skindis']),
