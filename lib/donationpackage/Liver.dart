...
class Liver extends StatelessWidget{
  CollectionReference liver_donors = FirebaseFirestore.instance.collection('liver_donors');
  late String name, address, dob, contact, kin_contact, kin_name, kin_address, kin_email,bloodgroup, heart, lung, bp, diabetes, smoke, alcohol, relation;
  @override
